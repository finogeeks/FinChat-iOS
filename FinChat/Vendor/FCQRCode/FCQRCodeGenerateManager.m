...
#import "FCQRCodeGenerateManager.h"

@implementation FCQRCodeGenerateManager
...
+ (UIImage *)generateWithLogoQRCodeData:(NSString *)data logoImageName:(NSString *)logoImageName logoScaleToSuperView:(CGFloat)logoScaleToSuperView {
    ...
    // 6、获取当前画得的这张图片
    UIImage *FCal_image = UIGraphicsGetImageFromCurrentImageContext();
