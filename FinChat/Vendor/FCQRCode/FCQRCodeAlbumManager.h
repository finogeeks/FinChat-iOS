...
@class FCQRCodeAlbumManager;

@protocol FCQRCodeAlbumManagerDelegate <NSObject>
...
@interface FCQRCodeAlbumManager : NSObject
/** 快速创建单利方法 */
+ (instancetype)sharedManager;
/** FCQRCodeAlbumManagerDelegate */
@property (nonatomic, weak) id<FCQRCodeAlbumManagerDelegate> delegate;
/** 判断相册访问权限是否授权 */
